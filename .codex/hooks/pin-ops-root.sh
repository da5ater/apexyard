...
# framework session state (`.codex/session/*`) resolve the ops-fork
...
# .codex/hooks/pin-ops-root.sh inside the ops fork.
...
pin_dir="${APEXYARD_OPS_PIN_DIR:-$HOME/.codex/apexyard}"
pin_file="$pin_dir/ops-root-${CODEX_SESSION_ID}"
