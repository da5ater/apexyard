...
run require-pending-rex-review.sh
...
run_for_payload() {
  ...
  for hook in require-pending-rex-review.sh require-migration-ticket.sh require-active-ticket.sh detect-role-trigger.sh warn-review-marker-write.sh; do
