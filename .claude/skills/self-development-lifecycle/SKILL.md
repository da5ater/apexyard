...
```bash
python3 .claude/skills/self-development-lifecycle/run.py path/to/source.md
.claude/skills/self-development-lifecycle/run.py path/to/source.md --session-id redux-toolkit-api-slice
python3 .claude/skills/self-development-lifecycle/run.py path/to/source.md --sessions-dir /path/to/vault/sessions
```
